...
public class Test1 {
	...
	public static void main(String[] args) {
		...
		//test1.assigngroup1("88EFDB5FEC2A534FB274DF6C24176928");
		test1.assigngroup("DA8E28DD79F79345A6E5EF5A8E1B81E9");
	...
	public static  void assigngroup1(String wbob)
	{
		 ...
		 Connection ceConnection = 
					...
					Subject ceSubject = UserContext.createSubject(ceConnection, FILENET_USERNAME, FILENET_PASSWORD,JAAS_STANZA_NAME );
		...
		System.out.println("Step Name " + query1.fetchCount());
	//	System.out.println("------------------------------------------------------------------------------------------------");	
	...
	*/
	...
	public static  void assigngroup(String wbob)
	{
		...
		//	peSession.setBootstrapCEURI(FILENET_URI);
			...
			// Set Query Parameters
			System.out.println(queue.fetchCount());
			String wobNum = wbob;
