...
public class IERRptEngSampleApp1 {
	...
	private static String rptDefinitionIdent = "File plan structure";
	...
	public static void main(String[] args) {
		try {
			...
			//rptParams.put("fileplan_name", PARAM_VALUE_FILEPLAN_NAME);
			rptParams.put("fileplan_browse", PARAM_VALUE_FILEPLAN_NAME);
