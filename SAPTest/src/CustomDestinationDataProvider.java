...
public class CustomDestinationDataProvider
{
    ...
    void executeCalls(String destName)
    {
        ...
        try
        {
            ...
            dest.getClient();
            System.out.println("dest.getClient() " + dest.getClient() + " works");
            
            //Add code here
            String vendor = null;
            String JCO_FUNCTION_NAME = "BAPI_PO_GETDETAIL";
            
            String poNumber="4500013560";
                ...
                JCoFunction jcoFunction = repository.getFunction("BAPI_PO_GETDETAIL");
                
                if(jcoFunction == null) {
                    String errorText = "Unable to create JCO Function : " + JCO_FUNCTION_NAME;
                    
                    
                }
                
                JCoParameterList importParams = jcoFunction.getImportParameterList();
                importParams.setValue("PURCHASEORDER", poNumber);
                ...
                JCoTable bapiReturnTable = tableParameterList.getTable("RETURN");
                
                
               
                    JCoStructure poHeader = exportParameterList.getStructure("PO_HEADER");
                    
                                        
                    vendor = poHeader.getString("VENDOR");
                    
                    String Cretaedby = poHeader.getString("CREATED_BY");
                    
                    System.out.println(vendor);
                    
                    System.out.println(Cretaedby);
    ...
    static Properties getDestinationPropertiesFromUI()
    {
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "192.168.1.222");
        connectProperties.setProperty(DestinationDataProvider.JCO_SYSNR,  "00");
        connectProperties.setProperty(DestinationDataProvider.JCO_CLIENT, "800");
        connectProperties.setProperty(DestinationDataProvider.JCO_USER,   "sapuser");
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, "sap123");
